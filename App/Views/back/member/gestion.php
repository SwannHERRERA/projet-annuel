<div class="mt-20 col-12">
    <div class="row mt-20 mb-20">
        <div class="col-md-4">
            <label for="filterMember">Rechercher</label>
            <input type="text" class="form-control" id="filterMember" onkeyup="filter()">
        </div>
    </div>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" value="permanent" checked name="type"
                                       id="permanent">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" value="temporaire" name="type"
                                       id="temporaire">
