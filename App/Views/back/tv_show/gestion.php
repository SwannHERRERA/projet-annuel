        ...
        <?php foreach ($tv_shows as $tv_show) : ?>
            <tr>
                ...
                <td class="text-center">
                    <a href="<?= $site_url . '/back/tv_show/edit?id=' . $tv_show['id_show'] ?>"><i
                                class="fas fa-edit"></i></a>
                    <a onclick="confdel('<?= $site_url . '/back/tv_show/remove?id=' . $tv_show['id_show'] ?>')"
                       class="text-danger"><i class="fas fa-trash-alt"></i></a>
                    <a href="<?= $site_url . '/back/tv_show/updateLight?show=' . $tv_show['id_show'] ?>"><i
                                class="fas fa-sync text-success"></i>
                    </a><a href="<?= $site_url . '/back/tv_show/updateHard?show=' . $tv_show['id_show'] ?>"><i
                                class="fas fa-sync text-danger"></i></a>
                </td>
            </tr>
        <?php endforeach; ?>
        </tbody>
